...
@contextmanager
def make_carla_client(host, world_port, timeout=1500000000):
...
class CarlaClient(object):
    ...
    def __init__(self, host, world_port, timeout=1500000000):
    ...
    def connect(self, connection_attempts=1000000000):
        """
    ...
    def send_control(self, *args, **kwargs):
        ...
        # check = isinstance(args[0] if args else None, carla_protocol.Control)
