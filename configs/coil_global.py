...
# train set episode limit - temporary
_g_conf.TRAIN_SET_EPISODE_LIMIT = 350

# sampling using dagger or normal
_g_conf.SAMPLE = None

# DART related parameters 
_g_conf.DART_COVMAT_DATA = "" # dart dataset for computing covariance shift
_g_conf.DART_MODEL_CHECKPOINT = "" # dart saved model checkpoint path

# full dataset path
_g_conf.PRE_TRAINED_DIRECTORY = ""
_g_conf.COIL_DATASET_PATH = ""
_g_conf.COVARIANCE_MATRIX_PATH = ""

"""#### Validation Related Parameters - Modified version ####"""
_g_conf.VALIDATION_CHECKPOINT_PATH = ""
_g_conf.VALIDATION_CHECKPOINT_ITERATION = ""
...
def set_type_of_process(process_type, param=None):
    ...
    # removing logging to avoid location name mismatch - temporary
