...
'''
def readJSONlog_duplicate(logfile, filterfunction=(lambda x: True), customjson=None):
    """Iterate through a log file of JSON records and return a list of JSON records that meet the filterfunction.
...
if __name__ == '__main__':
    ...
    file = open('/is/sg2/aprakash/Projects/carla_autonomous_driving/code/coiltraine/_logs/dagger/resnet34imnet10S1/train', 'r')
    data = readJSONlog_duplicate(file)
'''